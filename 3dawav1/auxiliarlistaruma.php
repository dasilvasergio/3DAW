...
<div class="container">
  <h2 align="center">LISTAR UMA DISCIPLINA</h2>
    <form class="form-inline" action="listarumadisciplina.php" method="POST">
    <div class="form-group">
      <label for="number">DIGITE O ID PARA EXIBIR A DISCIPLINA:</label>
