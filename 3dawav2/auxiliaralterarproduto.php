...
<head>
  ...
  <script>
     function modificarProduto() {
       ...
       let msg = alterarProduto(objProd);
       ...
       if(msg == "") {
        ...
        if (this.readyState == 4 && this.status == 200) {
            ...
            document.getElementById("resposta").innerHTML = this.response;  //obj.value;
...
function alterarProduto(Aproduto) {
...
<div class = "container">
  <h2 align = "center"> ALTERAR PRODUTO </h2>
    ...
    <div class = "form-group">
      ...
      <input type = "number" class = "form-control" id = "codigo" placeholder = "0 < Código > 10000" name = "codigo">
    </div>
    <div class = "form-group">
    ...
    <br><br><br>
   <input type="button" name="op" value="Alterar Produto" onclick= "modificarProduto()">
